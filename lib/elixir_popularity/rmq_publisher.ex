defmodule ElixirPopularity.RMQPublisher do
  ...
  @hn_item_ids_queue "hn_item_ids"
  @hn_bulk_item_data_queue "hn_bulk_item_data"
  ...
  def init do
    ...
    [connection: @rmq_uri, exchange: @hn_exchange]
  end
  ...
  def hn_item_ids_queue_size do
    GenRMQ.Publisher.message_count(__MODULE__, @hn_item_ids_queue)
  end

  def publish_hn_item_id(item_id) do
    GenRMQ.Publisher.publish(__MODULE__, item_id, @hn_item_ids_queue, @publish_options)
  end
  ...
  def item_ids_queue_name, do: @hn_item_ids_queue
  ...
  defp create_rmq_resources do
    ...
    AMQP.Queue.bind(
      ...
      @hn_item_ids_queue,
      @hn_exchange,
      routing_key: @hn_item_ids_queue
    )

    AMQP.Queue.bind(
      channel,
      @hn_bulk_item_data_queue,
      @hn_exchange,
      routing_key: @hn_bulk_item_data_queue
    )
